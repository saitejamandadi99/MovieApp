...
@Component({
  selector: 'app-delete-user-api-component',
  imports: [ReactiveFormsModule, NgIf],
  templateUrl: './delete-user-api-component.html',
  styleUrl: './delete-user-api-component.css',
})
export class DeleteUserApiComponent implements OnInit {
  ...
  deleteUser(){
    this.userSrc.deleteUser(this.id).subscribe(data=>console.log("post user", data), err=>console.log(err));
